...
static const std::unordered_map<std::string, std::function<int(IR_Interpreter &, IR_Interpreter::Args)> > name2Func = {
	...
	{"string.ord",&IR_Interpreter::string_ord},
	{"string.substring",&IR_Interpreter::string_substring}, 
	{"string.parseInt",&IR_Interpreter::string_parseInt},
	{"getString",&IR_Interpreter::getString},
	{"string.add",&IR_Interpreter::string_add},
	{"string.eq",&IR_Interpreter::string_eq}, 
	{"string.neq",&IR_Interpreter::string_neq},
	{"string.less",&IR_Interpreter::string_less},
	{"string.leq",&IR_Interpreter::string_leq},
	{"string.greater",&IR_Interpreter::string_greater}, 
	{"string.geq",&IR_Interpreter::string_geq},
